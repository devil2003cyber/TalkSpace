...
def audio_recording():
    ...
    tex = SER.emotionHelpr(rec_sub_dir)
    print(tex)
    # Send Flash message
...
def audio_dash():
    ...
    print("EMo main ",emotions[Emo_main])
    ...
    return render_template('audio_dash.html', emo=major_emotion, emo_other=major_emotion_other, prob=emotion_dist, prob_other=emotion_dist_other,converted_txt=emotions[Emo_main])
