...
class speechEmotionRecognition:
    ...
    Voice recording function
    '''
    def get_og(self,text):
        API_URL = "https://api-inference.huggingface.co/models/mrm8488/t5-base-finetuned-emotion"
        headers = {"Authorization": "Bearer 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"}
        ...
        emotion = output[0]['generated_text']
        return emotion
    ...
    Mel-spectogram computation
    '''
    def emotionHelpr(self,filename):       
        r = sr.Recognizer()
        ...
        try:
            krish = r.recognize_google(audio)
